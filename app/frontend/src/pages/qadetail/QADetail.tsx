...
import { askDetailApi, configApi, ChatAppResponse, ChatAppRequest, RetrievalMode, VectorFieldOptions, GPT4VInput } from "../../api";
...
export function Component(): JSX.Element {
    ...
    const makeApiRequest = async (question: string) => {
        ...
        try {
            ...
            const result = await askDetailApi(request, token);
            setAnswer(result);
        } catch (e) {
            setError(e);
        } finally {
        ...
        <div className={styles.oneshotContainer}>
            ...
            <div className={styles.emailBottomSection}>
                <div className={styles.emailQuestionInput}>
                    {!isLoading && answer && !error && <EvaluationInput disabled={isLoading} question={question} answer={answer} tabName={"qaDetail"} />}
                </div>
            </div>
...
Component.displayName = "QADetail";
