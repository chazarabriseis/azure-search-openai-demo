...
export const EvaluationInput = ({ onSend, disabled, placeholder, clearOnSend, initQuestion }: Props) => {
    ...
    return (
        <Stack horizontal className={styles.emailInputContainer}>
            <TextField
                className={styles.emailInputTextArea}
            ...
            />
            <div className={styles.emailInputButtonsContainer}>
